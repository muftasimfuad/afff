...
(function ($) {
    ...
    $.stickToMe = function ( configs ) {
        ...
        var reqsettings = {
            backgroundcss: {'z-index':'99999999','display':'none'},
            boxcss: {'z-index':'99999999','position':'fixed','left':'50%','top':'40%','height': (conth) + 'px','width': (contw ) + 'px', 'margin-left':(-contw/2)+'px', 'margin-top':(-conth/2) + 'px'}
        };
